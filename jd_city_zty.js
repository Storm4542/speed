...
[task_local]
#城城领现金
33 * * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_city.js, tag=城城领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "33 * * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_city.js,tag=城城领现金

===================================Surge================================
城城领现金 = type=cron,cronexp="33 * * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_city.js

====================================小火箭=============================
城城领现金 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_city.js, cronexpr="33 * * * *", timeout=3600, enable=true
 */
const $ = new Env('城城领现金');
...
let inviteCodes = ['RtGKzrqjF1yjfYCcRNYw15BocSvEiNofmCYf4nRXysd7uiwqAA','W9GgnJLBHVzyOePwd4N_mu7B6FCwhxhrjSNzI2iNjZaB5hY']
!(async () => {
  if (!cookiesArr[0]) {
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
     ...
     inviteCodes = ['RtGKzrqjF1yjfYCcRNYw15BocSvEiNofmCYf4nRXysd7uiwqAA','RtGKzr7yQ1ilfYScFtYzh9DoT8fmhmdwj3Sxvcyuhnm_k74YyQ','W9GgnJLBHVzyOePwd4N_mu7B6FCwhxhrjSNzI2iNjZaB5hY']
